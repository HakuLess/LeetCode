        ...
        for (i in 0 until count.size) {
            if (count[i] != 0) {
                ...
                if (c % 2 != 0) {
                    if (t >= c / 2) {
                        med = i.toDouble()
                        return doubleArrayOf(min.toDouble(), max.toDouble(), sum / c, med, mode.toDouble())
                    }
                } else {
                    if (c / 2 - t == 0) {
                        med += i
